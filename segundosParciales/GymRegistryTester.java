...
public class GymRegistryTester {
    public static void main(String[] args) {
        // Se instancia un GymRegistry para administrar los clientes y sus visitas del año 2021
        GymRegistry gymRegistry2021 = new GymRegistry();
        // Registra al cliente "Rodrigo" con la membrersía Beginner
        ...
        // Cantidad de visitas del cliente "Rodrigo" en todos los meses del año
        ...
        // pues supera el máximo de visitas por mes de su membresía.
        ...
        System.out.println("-----");
        // Registra al cliente "Mariana" con la categoría Pro
        ...
        System.out.println("-----");
        try {
            // Falla la cantidad de visitas del cliente "Ariel" en todos los meses del año
            // pues no se encuentra registrado
