...
public class FreeMarketTester {
    public static void main(String[] args) {
        ...
        /*
         * Imprime en orden alfabético todos los productos del mercado
         * que pertenezcan a la categoría Libros
         *
         * Don Quijote
         * Hamlet
        ...
        /*
         * Imprime en orden alfabético todos los productos del mercado
         * que pertenezcan a la categoría Alimentos
         *
         * No imprime nada pues no se agregaron productos para esa categoría
         */
        ...
        } catch (IllegalArgumentException ex) { System.out.println(ex.getMessage()); // Imprime: El producto no existe.
        }
        System.out.println("-----");
        try {
